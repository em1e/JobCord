...
from jobsky.exception import NaukriException
from jobsky.naukri.constant import headers as naukri_headers
from jobsky.naukri.util import (
    is_job_remote,
    parse_job_type,
...
class Naukri(Scraper):
    ...
    def __init__(
        ...
        # Merge naukri headers with optional user agent
        try:
            local_headers = naukri_headers.copy()
            if self.user_agent:
